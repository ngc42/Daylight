...
public:
    ...
    ~AppointmentDialog();
    int appointmentId() const { return m_apmData.m_appointmentId; }
    ...
    void setAppointmentValues(const AppointmentData & apmData, const RecurrenceData & recData);
...
private:
    ...
    AppointmentData m_apmData;
    RecurrenceData m_recData;
