...
public:
    ...
    void modifyAppointment(const AppointmentData & apmData, const RecurrenceData & recData);
    void setAppointmentsCalendar(const int appointmentId, const int calendarId);
    void removeAppointment(const int id);   // remove appointment from storage
...
signals:
    ...
    void signalLoadedAppointmentFromStorage(const AppointmentData & apmData, const RecurrenceData & recData);

public slots:
    void slotAppointmentAdd(const AppointmentData & apmData, const RecurrenceData & recData);
